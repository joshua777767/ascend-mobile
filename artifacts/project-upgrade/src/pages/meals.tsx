      ...
      <div className="p-4 max-w-2xl mx-auto">
        ...
        <div className="mb-7 space-y-3">
          <Textarea
            ...
            className="bg-card border-border min-h-[96px] resize-none text-sm"
                ...
                return (
                  <div key={i} className={cn("border p-4 space-y-3", colorClass)} data-testid={`meal-card-${i}`}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-3 pt-2">
                      ...
                      {meal.whatWasBad && (
                        <div>
                          <p className="text-[10px] font-semibold text-red-400 uppercase tracking-wider mb-1">What was bad</p>
