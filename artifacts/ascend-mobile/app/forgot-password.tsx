...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 26, fontFamily: "SpaceMono_700Bold", textAlign: "center" },
  subtitle: { fontSize: 14, fontFamily: "SpaceMono_400Regular", textAlign: "center", lineHeight: 20 },
  successBox: { flexDirection: "row", alignItems: "flex-start", gap: 10, padding: 16, borderRadius: 14, borderWidth: 1 },
  successText: { fontSize: 14, fontFamily: "SpaceMono_400Regular", flex: 1, lineHeight: 20 },
