...
const styles = StyleSheet.create({
  ...
  genBtnText: { fontSize: 13, fontFamily: "SpaceMono_700Bold" },
  ...
  typeText: { fontSize: 12, fontFamily: "SpaceMono_700Bold", textTransform: "capitalize" },
  calsText: { fontSize: 13, fontFamily: "SpaceMono_400Regular" },
  qualityBadge: { flexDirection: "row", alignItems: "center", gap: 4, paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8 },
  qualityText: { fontSize: 11, fontFamily: "SpaceMono_700Bold" },
  mealDesc: { fontSize: 15, fontFamily: "SpaceMono_400Regular", lineHeight: 22 },
  macroRow: { flexDirection: "row", gap: 12, flexWrap: "wrap" },
  macroChip: { flexDirection: "row", alignItems: "baseline", gap: 3 },
  macroValue: { fontSize: 14, fontFamily: "SpaceMono_700Bold" },
  macroLabel: { fontSize: 11, fontFamily: "SpaceMono_400Regular" },
  scoreBadge: { flexDirection: "row", alignItems: "baseline", paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8 },
  scoreValue: { fontSize: 14, fontFamily: "SpaceMono_700Bold" },
  scoreDenom: { fontSize: 10, fontFamily: "SpaceMono_400Regular" },
  structuredFeedback: { borderRadius: 10, borderWidth: 1, padding: 10, gap: 8 },
  feedbackSection: { gap: 2 },
  feedbackSectionLabel: { fontSize: 9, fontFamily: "SpaceMono_700Bold", letterSpacing: 0.8 },
  feedbackSectionText: { fontSize: 12, fontFamily: "SpaceMono_400Regular", lineHeight: 17 },
  feedbackBox: { flexDirection: "row", alignItems: "flex-start", gap: 8, padding: 10, borderRadius: 10, borderWidth: 1 },
  feedbackText: { fontSize: 12, fontFamily: "SpaceMono_400Regular", flex: 1, lineHeight: 18 },
  modalRoot: { flex: 1 },
  ...
  textArea: { borderRadius: 12, borderWidth: 1, padding: 14, fontSize: 15, fontFamily: "SpaceMono_400Regular", minHeight: 100, textAlignVertical: "top" },
  ...
  photoBtnText: { fontSize: 14, fontFamily: "SpaceMono_400Regular" },
  ...
  aiDisclaimerText: { fontSize: 11, fontFamily: "SpaceMono_400Regular", flex: 1, lineHeight: 16 },
  ...
  chipBtnText: { fontSize: 13, fontFamily: "SpaceMono_400Regular", textTransform: "capitalize" },
  genHero: { flexDirection: "row", alignItems: "flex-start", gap: 10, padding: 14, borderRadius: 12, borderWidth: 1 },
  genHeroText: { fontSize: 13, fontFamily: "SpaceMono_400Regular", flex: 1, lineHeight: 20 },
  genResultWrap: { gap: 12, marginTop: 8 },
  genResultHeader: { flexDirection: "row", alignItems: "center", gap: 8, flexWrap: "wrap" },
  genResultTitle: { fontSize: 14, fontFamily: "SpaceMono_700Bold" },
  genResultSub: { fontSize: 12, fontFamily: "SpaceMono_400Regular" },
  genOptionCard: { borderRadius: 14, borderWidth: 1, padding: 14, gap: 10 },
  genOptionName: { fontSize: 15, fontFamily: "SpaceMono_700Bold" },
  genOptionMacros: { flexDirection: "row", gap: 8, flexWrap: "wrap" },
  genMacroChip: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8 },
  genMacroVal: { fontSize: 12, fontFamily: "SpaceMono_700Bold" },
  genSection: { gap: 3 },
  genSectionLabel: { fontSize: 9, fontFamily: "SpaceMono_700Bold", letterSpacing: 0.8 },
  genSectionText: { fontSize: 13, fontFamily: "SpaceMono_400Regular", lineHeight: 19 },
});
