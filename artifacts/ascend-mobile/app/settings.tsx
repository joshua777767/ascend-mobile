...
const styles = StyleSheet.create({
  ...
  disclaimerTitle: { fontSize: 12, fontFamily: "SpaceMono_700Bold", textTransform: "uppercase", letterSpacing: 0.5 },
  disclaimerText: { fontSize: 12, fontFamily: "SpaceMono_400Regular", lineHeight: 18 },
  section: { marginBottom: 20 },
  sectionTitle: { fontSize: 11, fontFamily: "SpaceMono_700Bold", letterSpacing: 0.8, marginBottom: 6, marginLeft: 4 },
  sectionCard: { borderRadius: 16, borderWidth: 1, overflow: "hidden" },
  row: { flexDirection: "row", alignItems: "center", paddingHorizontal: 16, paddingVertical: 14, gap: 12 },
  rowIcon: { width: 34, height: 34, borderRadius: 10, alignItems: "center", justifyContent: "center" },
  rowText: { flex: 1 },
  rowLabel: { fontSize: 15, fontFamily: "SpaceMono_400Regular" },
  rowSublabel: { fontSize: 12, fontFamily: "SpaceMono_400Regular", marginTop: 1 },
  divider: { height: StyleSheet.hairlineWidth, marginLeft: 62 },
  dataInfo: { padding: 16, gap: 8 },
  dataInfoTitle: { fontSize: 14, fontFamily: "SpaceMono_700Bold", marginBottom: 4 },
  dataRow: { flexDirection: "row", alignItems: "flex-start", gap: 8 },
  dataDot: { width: 5, height: 5, borderRadius: 3, marginTop: 6 },
  dataItem: { fontSize: 13, fontFamily: "SpaceMono_400Regular", flex: 1, lineHeight: 19 },
  dataNote: { fontSize: 11, fontFamily: "SpaceMono_400Regular", lineHeight: 16, marginTop: 8 },
  version: { fontSize: 11, fontFamily: "SpaceMono_400Regular", textAlign: "center", lineHeight: 18, marginTop: 8 },
});
