      ...
      <div className="max-w-2xl mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-card border border-primary/40 p-6 space-y-4 relative overflow-hidden">
            ...
            <div>
              ...
              <p className="text-sm font-semibold text-foreground mt-1">
                Then $19.99/month after {TRIAL_DAYS} days
              </p>
          ...
          <div className="bg-card border border-border p-6 space-y-4">
            <div>
              <p className="text-xs font-semibold uppercase tracking-wider text-muted-foreground mb-1">Ascend Pro</p>
              <p className="text-sm font-bold text-foreground mb-2 leading-snug">Skip the trial.<br />Start your transformation today.</p>
              <div className="flex items-end gap-1">
