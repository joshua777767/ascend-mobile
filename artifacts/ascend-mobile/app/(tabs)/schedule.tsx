...
const styles = StyleSheet.create({
  ...
  pageTitle: { fontSize: 26, fontFamily: "SpaceMono_700Bold", marginBottom: 2 },
  dateLabel: { fontSize: 13, fontFamily: "SpaceMono_400Regular" },
  ...
  missionBannerLabel: { fontSize: 10, fontFamily: "SpaceMono_700Bold", letterSpacing: 0.7, marginBottom: 3 },
  missionBannerText: { fontSize: 14, fontFamily: "SpaceMono_400Regular", lineHeight: 20 },
  ...
  targetChipText: { fontSize: 11, fontFamily: "SpaceMono_700Bold" },
  scheduleHint: { fontSize: 11, fontFamily: "SpaceMono_400Regular", marginTop: 8, textAlign: "center" },
  progressBar: { height: 4, borderRadius: 2, overflow: "hidden", marginBottom: 6 },
  progressFill: { height: 4, borderRadius: 2 },
  progressLabel: { fontSize: 12, fontFamily: "SpaceMono_400Regular", marginBottom: 16 },
  ...
  time: { fontSize: 11, fontFamily: "SpaceMono_400Regular" },
  missedLabel: { fontSize: 9, fontFamily: "SpaceMono_700Bold", marginTop: 2 },
  ...
  nextUpText: { fontSize: 10, fontFamily: "SpaceMono_700Bold" },
  ...
  typeText: { fontSize: 11, fontFamily: "SpaceMono_700Bold", textTransform: "capitalize" },
  actionBtn: { width: 30, height: 30, borderRadius: 8, borderWidth: 1, alignItems: "center", justifyContent: "center" },
  blockTitle: { fontSize: 15, fontFamily: "SpaceMono_700Bold", marginBottom: 4 },
  blockNotes: { fontSize: 12, fontFamily: "SpaceMono_400Regular", lineHeight: 18 },
  modalRoot: { flex: 1 },
  ...
  typeBtnText: { fontSize: 13, fontFamily: "SpaceMono_400Regular", textTransform: "capitalize" },
  timeAdjBtn: { paddingHorizontal: 7, height: 30, borderRadius: 8, borderWidth: 1, alignItems: "center", justifyContent: "center" },
  timeAdjText: { fontSize: 11, fontFamily: "SpaceMono_700Bold" },
});
