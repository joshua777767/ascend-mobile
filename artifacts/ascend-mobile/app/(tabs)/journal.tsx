            ...
            <View style={[styles.todayCard, { backgroundColor: colors.card, borderColor: colors.primary + "44" }]}>
              ...
              <View style={styles.ratings}>
                <View style={styles.ratingChip}>
                  ...
                  <Text style={[styles.ratingChipText, { color: colors.mutedForeground }]}>Energy: <Text style={{ color: colors.foreground, fontFamily: "SpaceMono_700Bold" }}>{today.energyRating}/10</Text></Text>
                </View>
              </View>
            </View>
...
const styles = StyleSheet.create({
  ...
  dateSub: { fontSize: 13, fontFamily: "SpaceMono_400Regular", marginBottom: 20 },
  ...
  todayTitle: { fontSize: 15, fontFamily: "SpaceMono_700Bold" },
  ...
  boolChipText: { fontSize: 12, fontFamily: "SpaceMono_400Regular" },
  winBox: { flexDirection: "row", alignItems: "flex-start", gap: 8, padding: 10, borderRadius: 10, borderWidth: 1 },
  winText: { fontSize: 13, fontFamily: "SpaceMono_400Regular", flex: 1, lineHeight: 18 },
  ratings: { flexDirection: "row", gap: 12 },
  ratingChip: { flexDirection: "row", alignItems: "center", gap: 6 },
  ratingChipText: { fontSize: 13, fontFamily: "SpaceMono_400Regular" },
  ...
  reviewTitle: { flex: 1, fontSize: 15, fontFamily: "SpaceMono_700Bold" },
  reviewScoreBadge: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 20 },
  reviewScoreText: { fontSize: 13, fontFamily: "SpaceMono_700Bold" },
  paceBadge: { flexDirection: "row", alignItems: "center", gap: 8, padding: 10, borderRadius: 10, borderWidth: 1 },
  paceText: { fontSize: 13, fontFamily: "SpaceMono_400Regular", flex: 1 },
  reviewRow: { flexDirection: "row", alignItems: "flex-start", gap: 10 },
  reviewRowLabel: { fontSize: 11, fontFamily: "SpaceMono_400Regular", textTransform: "uppercase", letterSpacing: 0.5, marginBottom: 3 },
  reviewRowText: { fontSize: 14, fontFamily: "SpaceMono_400Regular", lineHeight: 20 },
  fixBox: { flexDirection: "row", alignItems: "flex-start", gap: 10, padding: 12, borderRadius: 10, borderWidth: 1 },
  coachMessage: { fontSize: 13, fontFamily: "SpaceMono_400Regular", lineHeight: 20, fontStyle: "italic" },
  reviewLoading: { flexDirection: "row", alignItems: "center", gap: 12, padding: 16, borderRadius: 14, borderWidth: 1, marginBottom: 24 },
  reviewLoadingText: { fontSize: 14, fontFamily: "SpaceMono_400Regular" },
  emptyToday: { borderRadius: 16, borderWidth: 1, padding: 24, marginBottom: 24, alignItems: "center", gap: 10 },
  emptyTodayTitle: { fontSize: 17, fontFamily: "SpaceMono_700Bold" },
  emptyTodayText: { fontSize: 14, fontFamily: "SpaceMono_400Regular", textAlign: "center", lineHeight: 20 },
  ...
  sectionLabel: { fontSize: 11, fontFamily: "SpaceMono_700Bold", letterSpacing: 0.8, marginBottom: 10, marginTop: 4 },
  entryRow: { flexDirection: "row", alignItems: "center", borderRadius: 12, borderWidth: 1, padding: 14, gap: 12, marginBottom: 8 },
  entryInfo: { flex: 1 },
  entryDate: { fontSize: 14, fontFamily: "SpaceMono_700Bold" },
  entryWin: { fontSize: 12, fontFamily: "SpaceMono_400Regular", marginTop: 2 },
  scoreChip: { paddingHorizontal: 10, paddingVertical: 5, borderRadius: 20 },
  scoreChipText: { fontSize: 13, fontFamily: "SpaceMono_700Bold" },
  modalRoot: { flex: 1 },
  ...
  formSection: { fontSize: 11, fontFamily: "SpaceMono_700Bold", letterSpacing: 0.8, marginTop: 8, marginBottom: 8 },
  toggleGrid: { gap: 8 },
  toggleRow: { flexDirection: "row", alignItems: "center", gap: 10, padding: 14, borderRadius: 12, borderWidth: 1 },
  toggleLabel: { fontSize: 14, fontFamily: "SpaceMono_400Regular" },
  scorePreview: { padding: 12, borderRadius: 10, borderWidth: 1, alignItems: "center" },
  scorePreviewText: { fontSize: 13, fontFamily: "SpaceMono_700Bold" },
  ...
  ratingNum: { fontSize: 13, fontFamily: "SpaceMono_700Bold" },
  textArea: { borderRadius: 12, borderWidth: 1, padding: 14, fontSize: 15, fontFamily: "SpaceMono_400Regular", textAlignVertical: "top", minHeight: 72 },
  perfectDayBadge: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 20, borderWidth: 1 },
  perfectDayText: { fontSize: 12, fontFamily: "SpaceMono_700Bold" },
});
