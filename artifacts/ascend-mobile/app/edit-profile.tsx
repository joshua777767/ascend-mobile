...
const styles = StyleSheet.create({
  ...
  fieldLabel: { fontSize: 11, fontFamily: "Inter_600SemiBold", textTransform: "uppercase", letterSpacing: 0.6, marginTop: 6 },
  input: { borderRadius: 12, borderWidth: 1, paddingHorizontal: 14, paddingVertical: 12, fontSize: 15, fontFamily: "Inter_400Regular", marginTop: 4 },
  ...
  stepperLabel: { fontSize: 14, fontFamily: "Inter_400Regular" },
  ...
  stepperValue: { width: 40, textAlign: "center", fontSize: 16, fontFamily: "Inter_600SemiBold" },
  ...
  commitLabel: { fontSize: 14, fontFamily: "Inter_600SemiBold" },
  commitDesc: { fontSize: 12, fontFamily: "Inter_400Regular", marginTop: 2 },
});
