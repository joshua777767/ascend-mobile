...
const styles = StyleSheet.create({
  ...
  dateSub: { fontSize: 13, fontFamily: "Inter_400Regular", marginBottom: 2 },
  pageTitle: { fontSize: 26, fontFamily: "Inter_700Bold" },
  sectionLabel: { fontSize: 11, fontFamily: "Inter_600SemiBold", letterSpacing: 0.8, marginBottom: 12 },
  ...
  progressBadgeText: { fontSize: 13, fontFamily: "Inter_600SemiBold" },
  exerciseCard: { borderRadius: 14, borderWidth: 1, padding: 14 },
  exerciseTop: { flexDirection: "row", alignItems: "flex-start", gap: 10 },
  exerciseInfo: { flex: 1 },
  exerciseName: { fontSize: 15, fontFamily: "Inter_600SemiBold", marginBottom: 4 },
  exerciseMeta: { flexDirection: "row", gap: 14 },
  exerciseMetaText: { fontSize: 12, fontFamily: "Inter_400Regular" },
  ...
  coachTipLabel: { fontSize: 11, fontFamily: "Inter_600SemiBold", marginBottom: 4 },
  coachTipText: { fontSize: 13, fontFamily: "Inter_400Regular", lineHeight: 18 },
  ...
  loggedTitle: { fontSize: 15, fontFamily: "Inter_600SemiBold" },
  loggedSub: { fontSize: 12, fontFamily: "Inter_400Regular", marginTop: 2 },
  restCard: { borderRadius: 16, borderWidth: 1, padding: 32, alignItems: "center", gap: 10, marginBottom: 8 },
  restTitle: { fontSize: 17, fontFamily: "Inter_600SemiBold" },
  restSub: { fontSize: 14, fontFamily: "Inter_400Regular", textAlign: "center", lineHeight: 20 },
  historyList: { gap: 8 },
