...
export const GetUserProfileResponse = zod.object({
  ...
  "activityLevel": zod.union([zod.literal('sedentary'),zod.literal('light'),zod.literal('moderate'),zod.literal('high'),zod.literal('extra_active'),zod.literal(null)]).nullish(),
